...
public class Level2 {
    ...
    public static void main(String[] args) throws Exception{
            ...
            File f=new File("C:\\Users\\Asus\\Documents\\NetBeansProjects\\Lab Assignment 1 (CSE221)\\Input 2.txt");
            ...
            st=br.readLine();
            int nora=Integer.parseInt(st);
            st=br.readLine();
            int lara=Integer.parseInt(st);
            
            if(BFS(list, nora, vertices, target) < BFS(list, lara, vertices, target))
